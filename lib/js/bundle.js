...
var Util = {
  ...
  turnCubeToFace: function turnCubeToFace(cube, face) {
    switch (face) {
      case "front":
        Util.turnCubeToAngle(cube, 0, 0);
        break;
      case "back":
        Util.turnCubeToAngle(cube, 180, 0);
        break;
      case "left":
        Util.turnCubeToAngle(cube, 90, 0);
        break;
      case "right":
        Util.turnCubeToAngle(cube, 270, 0);
        break;
      case "top":
        Util.turnCubeToAngle(cube, 0, -45);
        break;
      case "bottom":
        Util.turnCubeToAngle(cube, 0, 45);
        break;
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  var game = new Game({ $cube: $cube, $score: $score });
  game.draw();
