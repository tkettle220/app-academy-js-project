...
document.addEventListener("DOMContentLoaded", function () {
  ...
  var game = new Game({ $cube: $cube, $score: $score, $newGameButton: $newGameButton });
  game.draw();
  ...
  $newGameButton.on("click", function (event) {
    ...
    game = new Game({ $cube: $cube, $score: $score, $newGameButton: $newGameButton });
