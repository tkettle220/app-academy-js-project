      ...
      this.coins.forEach(function (coin) {
        if (Util.inSamePos(coin, player)) {
          ...
          if (_this.score % 2 == 0) {
            ...
            if (_this.level % LEVELS.length == 0 && _this.level != 0) {
              _this.enemySpeed = _this.enemySpeed * (4 / 5);
...
var e3 = new Enemy({ face: "left", pos: [1, 1], direction: [0, 1] });
...
var e7 = new Enemy({ face: "front", pos: [0, 1], direction: [0, 1] });
var e8 = new Enemy({ face: "front", pos: [0, 1], direction: [0, 1] });
...
var LEVELS = [{ enemies: [e1, e2] }, { enemies: [e3, e4] }, { enemies: [e5, e6] }, { enemies: [e7, e8] }];
