...
var Input = function () {
  ...
  _createClass(Input, null, [{
    key: "disableCubeKeys",
    value: function disableCubeKeys() {
      key("w", function () {});
      key("a", function () {});
      key("s", function () {});
      key("d", function () {});
    ...
    key: "bindCubeKeys",
    value: function bindCubeKeys(cube, hRot, vRot) {
      if (hRot && vRot) {
        cube.data('h-rot', hRot);
        cube.data('v-rot', vRot);
      }
    ...
    value: function detectCollision(player) {
      ...
      this.coins.forEach(function (coin) {
        if (Util.inSamePos(coin, player)) {
          ...
          if (_this.score % 10 == 0) {
            _this.level += 1;
            _this.beginNewLevel(LEVELS[_this.level % LEVELS.length]);
          } else {
            _this.spawnCoin();
          }
        }
...
var e1 = new Enemy({ face: "front", pos: [0, 0], direction: [0, 1] });
var e2 = new Enemy({ face: "front", pos: [2, 0], direction: [0, 1] });
//Second level: Two perpendicular enemies, one across, one top/bottom
var e3 = new Enemy({ face: "left", pos: [0, 1], direction: [0, 1] });
var e4 = new Enemy({ face: "top", pos: [1, 1], direction: [1, 0] });

//Third level, enemies wrapping all three directions on cube
var e5 = new Enemy({ face: "left", pos: [1, 0], direction: [0, 1] });
var e6 = new Enemy({ face: "bottom", pos: [0, 1], direction: [1, 0] });
var e7 = new Enemy({ face: "left", pos: [0, 2], direction: [1, 0] });

//fourth level: enemies form walls in pairs
var e8 = new Enemy({ face: "right", pos: [0, 0], direction: [0, -1] });
var e9 = new Enemy({ face: "right", pos: [2, 0], direction: [0, -1] });
var e10 = new Enemy({ face: "left", pos: [0, 2], direction: [0, 1] });
var e11 = new Enemy({ face: "left", pos: [0, 1], direction: [0, 1] });

//fifth level: three diamonds
var e12 = new Enemy({ face: "left", pos: [0, 1], direction: [0, 1] });
var e13 = new Enemy({ face: "left", pos: [1, 0], direction: [0, 1] });
var e14 = new Enemy({ face: "left", pos: [1, 2], direction: [0, 1] });
var e15 = new Enemy({ face: "left", pos: [2, 1], direction: [0, 1] });
var e16 = new Enemy({ face: "right", pos: [0, 1], direction: [0, 1] });
var e17 = new Enemy({ face: "right", pos: [1, 0], direction: [0, 1] });
var e18 = new Enemy({ face: "right", pos: [1, 2], direction: [0, 1] });
var e19 = new Enemy({ face: "right", pos: [2, 1], direction: [0, 1] });
var e20 = new Enemy({ face: "top", pos: [0, 1], direction: [0, -1] });
var e21 = new Enemy({ face: "top", pos: [1, 0], direction: [0, -1] });
var e22 = new Enemy({ face: "top", pos: [1, 2], direction: [0, -1] });
var e23 = new Enemy({ face: "top", pos: [2, 1], direction: [0, -1] });

//6th: random 2 enemies on all faces except front
var e24 = new Enemy({ face: "left", pos: [1, 2], direction: [0, -1] });
var e25 = new Enemy({ face: "left", pos: [0, 2], direction: [2, 1] });
var e26 = new Enemy({ face: "right", pos: [1, 2], direction: [1, 1] });
var e27 = new Enemy({ face: "right", pos: [1, 0], direction: [0, -1] });
var e28 = new Enemy({ face: "top", pos: [1, 0], direction: [0, -1] });
var e29 = new Enemy({ face: "top", pos: [1, 1], direction: [-1, 0] });
var e30 = new Enemy({ face: "bottom", pos: [0, 1], direction: [0, -1] });
var e31 = new Enemy({ face: "bottom", pos: [2, 1], direction: [0, -1] });
var e32 = new Enemy({ face: "back", pos: [2, 0], direction: [1, 0] });
var e33 = new Enemy({ face: "back", pos: [2, 1], direction: [0, -1] });

var LEVELS = [{ enemies: [e1, e2] }, { enemies: [e3, e4] }, { enemies: [e5, e6, e7] }, { enemies: [e8, e9, e10, e11] }, { enemies: [e12, e13, e14, e15, e16, e17, e18, e19, e20, e21, e22, e23] }, { enemies: [e24, e25, e26, e27, e28, e29, e30, e31, e32, e33] }];
