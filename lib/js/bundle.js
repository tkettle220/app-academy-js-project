...
document.addEventListener("DOMContentLoaded", function () {
  ...
  var game = new Game({ $cube: $cube, $score: $score, $newGameButton: $newGameButton, $level: $level });
  game.draw();
  ...
  $newGameButton.on("click", function (event) {
    ...
    game = new Game({ $cube: $cube, $score: $score, $newGameButton: $newGameButton, $level: $level });
    $level.text("0");
