...
class Game {
 ...
 allObjects() {
  ...
  beginNewLevel(level) {
    ...
    this.$cube.css("-webkit-transform", "rotateX(0deg) rotateY(45deg)");

    this.$cube.data('v-rot', 45);
...
let e1 = new Enemy({face: "left", pos: [1,1], direction:[0,1]});
let e2 = new Enemy({face: "top", pos: [1,1], direction:[1,0]});
